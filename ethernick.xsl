  ...
  <div class="jumbotron">
	...
	<div class="container">
      <div class="row marketing">
			<xsl:for-each select="document('pr.xml')/rss/channel[1]/item[position() &gt;= 1 and position() &lt; 7]">
          ...
          <p>I've been toying around the web for roughly 15 years. Everything from
